          ...
          <div class="spotbox-menu">
            <div class="spotbox-menu--inner">
              ...
              <ul class="spotbox-menu--list">
                <li class="spotbox-menu--list-item first"><a href="community.php"><i class="icon-check-empty"></i>Alle</a></li>
                <li class="spotbox-menu--list-item first"><a href="community-forum.php"><i class="icon-check-empty"></i>Forum</a></li>
                <li class="spotbox-menu--list-item"><a href="community-use-cases.php"><i class="icon-check-empty"></i>Use cases</a></li>
